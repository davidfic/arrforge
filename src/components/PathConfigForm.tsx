...
export function PathConfigForm({ state, dispatch }: PathConfigFormProps) {
  return (
    <div className="space-y-6">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Folder Structure Preview</label>
        <pre className="bg-gray-900 border border-gray-800 rounded-lg p-4 text-xs text-gray-400 overflow-x-auto">
{`${state.basePath}/
