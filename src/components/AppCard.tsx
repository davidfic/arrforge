  ...
  return (
    <button
      ...
      className={`text-left w-full p-4 rounded-xl border transition-all ${
        selected
          ? 'bg-purple-950/40 border-purple-700 ring-1 ring-purple-700/50'
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {app.starter && (
              <span className="text-[10px] px-1.5 py-0.5 rounded bg-purple-900/50 text-purple-400 border border-purple-800 whitespace-nowrap">
                Starter
              </span>
            )}
          </div>
